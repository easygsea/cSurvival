...
# 
# 
# target_df <- data.frame(c(1,2,3),c(1,1,1))
# names(target_df) <- c("first","pvalue")
# index_df <- data.frame(c(1,2,3),c(4,5,6))
# names(index_df) <- c("index","pvalue")
# 
# target_df$pvalue[index_df$index] <- as.numeric(index_df$pvalue)
# 
# 
# update_p_values <- function(target_df,index_df){
#   result <- target_df
#   result$pvalue[index_df$index] <- as.numeric(index_df$pvalue)
#   return(result)
# }
# 
# 
# target_df <- update_p_values(target_df,index_df)