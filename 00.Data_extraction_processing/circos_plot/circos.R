...
circos.text(x = c(1,1.75:32.75), y = CELL_META$cell.ylim[2] * text_coefficient, labels = paste0(as.character(round(unlist(calculate_survival_rate(TCGA,3)),2) * 100),"%"), cex = 0.4, facing = "bending.outside", niceFacing = TRUE, sector.index	= "TCGA", track.index = 2)
circos.text(x = c(1,1.75:32.75), y = CELL_META$cell.ylim[2] * text_coefficient * 0.84, labels = paste0(as.character(round(unlist(calculate_survival_rate(TCGA,5)),2) * 100),"%"), cex = 0.4, facing = "bending.outside", niceFacing = TRUE, sector.index	= "TCGA", track.index = 2)
circos.text(x = c(1,1.75:32.75), y = CELL_META$cell.ylim[2] * text_coefficient * 0.68, labels = paste0(as.character(round(unlist(calculate_survival_rate(TCGA,10)),2) * 100),"%"), cex = 0.4, facing = "bending.outside", niceFacing = TRUE, sector.index	= "TCGA", track.index = 2)
...
circos.text(x = c(0.75,1.75:8.75), y = CELL_META$cell.ylim[2] * text_coefficient, labels = paste0(as.character(round(unlist(calculate_survival_rate(TARGET,3)),2) * 100),"%"), cex = 0.4, facing = "bending.outside", niceFacing = TRUE, sector.index	= "TARGET", track.index = 2)
circos.text(x = c(0.75,1.75:8.75), y = CELL_META$cell.ylim[2] * text_coefficient * 0.84, labels = paste0(as.character(round(unlist(calculate_survival_rate(TARGET,5)),2) * 100),"%"), cex = 0.4, facing = "bending.outside", niceFacing = TRUE, sector.index	= "TARGET", track.index = 2)
circos.text(x = c(0.75,1.75:8.75), y = CELL_META$cell.ylim[2] * text_coefficient * 0.68, labels = paste0(as.character(round(unlist(calculate_survival_rate(TARGET,10)),2) * 100),"%"), cex = 0.4, facing = "bending.outside", niceFacing = TRUE, sector.index	= "TARGET", track.index = 2)
