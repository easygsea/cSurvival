...
gmt_dir <- paste0(dirname(getwd()),"/eVITTA/RELEASE/easyGSEA/www/gmts/hsa/")
# collection in a df
gmt_collection_df <- read_csv(paste0(dirname(getwd()),"/eVITTA/RELEASE/easyGSEA/www/gmts/gmts_list.csv"),col_names = F) %>% dplyr::filter(X1 == "hsa")
# available databases
