              ...
              div(
                ...
                ,column(
                  ...
                  ,conditionalPanel(
                    ...
                    p(style="color:red;",HTML("<b>Exhaustive search</b> needs longer run time. It may reduce statistical power (i.e. increase adjusted <i>P</i>-value) since it requires heavier penalty on multiple testing adjustment."))
                  )
                )
              )
            }
