  ...
  showModal(
    modalDialog(
      ...
      fluidRow(style = "font-size:110%;",
               column(
                 12,
                 HTML("<p style='font-weight: bold; font-size: large'>Click to access <a href='http://tau.cmmt.ubc.ca:4500/__docs__/' target='_blank'>cSurvival's API <i class='fas fa-external-link-alt fa-sm'></i></a></p>"),
