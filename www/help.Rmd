...
To test if the missense (potentially gain-of-function) mutation status of Kirsten rat sarcoma 2 viral oncogene homolog (KRAS) and copy number gains of Phosphatidylinositol-4,5-Bisphosphate 3-Kinase Catalytic Subunit Alpha (PIK3CA)  are jointly associated with overall survival in pancreatic adenocarcinoma (TCGA-PAAD):
